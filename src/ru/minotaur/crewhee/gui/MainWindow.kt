...
//    private val textAreaPanel : JPanel
    ...
    private val mapListScroller = JScrollPane(mapList)
...
//        mapListScroller.preferredSize = Dimension(5, 5)
        ...
        textArea.maximumSize = Dimension(MAP_WIDTH * 16, MAP_HEIGHT * 24)

        gamePanelBox.add(textArea, BorderLayout.CENTER)
//        gamePanelBox.add(Box.Filler(Dimension(0, 100),
//            Dimension(0, 200),
//            Dimension(0, 1000)
//        ))
        ...
        frame.preferredSize = Dimension(400, 500)
    }
